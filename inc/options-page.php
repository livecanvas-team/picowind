...
//ADD THEME OPTIONS PAGE
function add_picowind_theme_page() {
    add_theme_page( 'picowind Theme Options Page', 'picowind Options', 'edit_theme_options', 'picowind-theme-options', 'theme_option_page' );
}
add_action( 'admin_menu', 'add_picowind_theme_page' );
	...
	<div class="pico-wrap">
        ...
        <div class="pico-welcome-panel">
            ...
            <div class="pico-welcome-panel-content">
                ...
                <h2 style="float:right" > picowind v<?php echo pico_get_parent_theme_version() ?></h2>
                <p class="about-description">The best way to experience Tailwind on  WordPress</p>
                 
                <p><i>Integrates with the WindPress plugin which does completely control the CSS world.</i></p>
                ...
                <div class="pico-container">
					...
					<div hidden class="pico-column" style="width:55%;">
							<style>
								.button-hero { min-width: 58%;text-align: center; }
							</style>
                            <h3>Get Started</h3>
                            <a class="button button-hero" target="_blank" href="https://picowind.com/docs/">Theme Documentation</a>
							<br><br>
		...
		<div class="metabox-holder">
			<div class="postbox" style="padding: 0 10px;"> 
				...
				if (  get_template_directory() === get_stylesheet_directory()) {
					echo '
					<h2>Please do not edit directly the picowind theme folder. </h2>
					
					<p>To add your code, you need to enable a child theme. Download our child theme starter for free at <a target="_new" href="https://picowind.com/#downloads">picowind.com</a>. </p>
