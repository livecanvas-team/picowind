...
add_action( 'wp_footer', function(){ ?>
	...
	<div id="picowind-page-top-indicator" class="position-absolute w-100 top-0" style="height:5px">
	</div>
	...
	<script>
		document.addEventListener('DOMContentLoaded', function(event) {
			...
			if(!!window.IntersectionObserver){
				...
				picoBodyScrolledObserver.observe(document.querySelector('#picowind-page-top-indicator')) ;
			}
		});
	</script>
