...
if ( ! function_exists( 'picowind_pagination' ) ) {
	/**
	 ...
	 */
	function picowind_pagination( $args = array(), $class = 'pagination pagination-lg' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'picowind' ),
				'next_text'          => __( '&raquo;', 'picowind' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'picowind' ),
			)
		);
