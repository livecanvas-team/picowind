...
use PicowindDeps\Doctrine\DBAL\ArrayParameterType;
use PicowindDeps\Doctrine\DBAL\Configuration;
use PicowindDeps\Doctrine\DBAL\Connection;
use PicowindDeps\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use PicowindDeps\Doctrine\DBAL\DriverManager;
use PicowindDeps\Doctrine\DBAL\Exception as DBALException;
use PicowindDeps\Doctrine\DBAL\Exception\TableNotFoundException;
use PicowindDeps\Doctrine\DBAL\ParameterType;
use PicowindDeps\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use PicowindDeps\Doctrine\DBAL\Schema\Schema;
use PicowindDeps\Doctrine\DBAL\ServerVersionProvider;
use PicowindDeps\Doctrine\DBAL\Tools\DsnParser;
...
use PicowindDeps\Symfony\Component\Cache\PruneableInterface;
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getPlatformName(): string
    {
        ...
        return $this->platformName = match (\true) {
            $platform instanceof \PicowindDeps\Doctrine\DBAL\Platforms\MySQLPlatform, $platform instanceof \PicowindDeps\Doctrine\DBAL\Platforms\MySQL57Platform => 'mysql',
            $platform instanceof \PicowindDeps\Doctrine\DBAL\Platforms\SqlitePlatform => 'sqlite',
            $platform instanceof \PicowindDeps\Doctrine\DBAL\Platforms\PostgreSQLPlatform, $platform instanceof \PicowindDeps\Doctrine\DBAL\Platforms\PostgreSQL94Platform => 'pgsql',
            $platform instanceof \PicowindDeps\Doctrine\DBAL\Platforms\OraclePlatform => 'oci',
            $platform instanceof \PicowindDeps\Doctrine\DBAL\Platforms\SQLServerPlatform, $platform instanceof \PicowindDeps\Doctrine\DBAL\Platforms\SQLServer2012Platform => 'sqlsrv',
