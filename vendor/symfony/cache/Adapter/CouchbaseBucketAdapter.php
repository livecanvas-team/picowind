...
class CouchbaseBucketAdapter extends AbstractAdapter
{
    ...
    private \PicowindDeps\CouchbaseBucket $bucket;
    private MarshallerInterface $marshaller;
    public function __construct(\PicowindDeps\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, ?MarshallerInterface $marshaller = null)
    {
    ...
    public static function createConnection(#[\SensitiveParameter] array|string $servers, array $options = []): \PicowindDeps\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \PicowindDeps\CouchbaseCluster($connectionString);
