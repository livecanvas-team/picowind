...
{
    public function __construct(public ExpressionNode $needle, public ExpressionNode $haystack, public ?Position $position = null)
    {
    }
    public function print(PrintContext $context): string
    {
        return 'in_array(' . $this->needle->print($context) . ', ' . $this->haystack->print($context) . ', true)';
    }
