...
{
    public const KindNormal = 1, KindFullyQualified = 2;
    public function __construct(public string $name, public int $kind = self::KindNormal, public ?Position $position = null)
    {
        if ($name === '') {
