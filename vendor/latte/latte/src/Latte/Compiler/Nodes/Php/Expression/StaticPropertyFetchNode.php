...
use PicowindDeps\Latte\Compiler\Nodes\Php\VarLikeIdentifierNode;
...
{
    public function __construct(public NameNode|ExpressionNode $class, public VarLikeIdentifierNode|ExpressionNode $name, public ?Position $position = null)
    {
    }
