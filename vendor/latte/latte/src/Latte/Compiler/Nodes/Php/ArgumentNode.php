...
{
    public function __construct(public ExpressionNode $value, public bool $byRef = \false, public bool $unpack = \false, public ?IdentifierNode $name = null, public ?Position $position = null)
    {
    }
    public function print(PrintContext $context): string
    {
        return ($this->name ? $this->name . ': ' : '') . ($this->byRef ? '&' : '') . ($this->unpack ? '...' : '') . $this->value->print($context);
    }
