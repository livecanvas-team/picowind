...
XX
, $this->position, $this->content, $escaper->getState() === Escaper::HtmlText ? 'ob_get_length() ? new LR\Html(ob_get_clean()) : ob_get_clean()' : 'ob_get_clean()', $escaper->export(), $this->variable, $this->modifier);
    }
