...
class DefineNode extends StatementNode
{
    ...
    {
        return $this->block->isDynamic() ? $this->printDynamic($context) : $this->printStatic($context);
    }
    ...
    private function printDynamic(PrintContext $context): string
    {
        ...
        $this->block->content = $this->content->print($context);
        // must be compiled after is added
        return $context->format('$this->addBlock(%raw, %dump, [[$this, %dump]], %dump);', $context->ensureString($this->block->name, 'Block name'), $context->getEscaper()->export(), $this->block->method, $this->block->layer);
    }
