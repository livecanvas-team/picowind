...
use PicowindDeps\Nette\PhpGenerator as Php;
...
{
    public function generateTemplateClass(array $params, ?string $name = 'Template', ?string $extends = null): Php\ClassType
    {
    ...
    public function printParameters(Php\Closure|Php\GlobalFunction|Php\Method $function, ?Php\PhpNamespace $namespace = null): string
    {
        $params = [];
