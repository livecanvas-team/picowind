...
class MethodCallNode extends Expression\MethodCallNode
{
    ...
    {
        return '$this->global->sandbox->callMethod(' . $this->object->print($context) . ', ' . $context->memberAsString($this->name) . ', ' . $context->argumentsAsArray($this->args) . ', ' . var_export($this->nullsafe, \true) . ')';
    }
}
