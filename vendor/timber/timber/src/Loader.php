...
use PicowindDeps\Timber\Cache\Cleaner;
use PicowindDeps\Twig\CacheExtension;
use PicowindDeps\Twig\Environment;
use PicowindDeps\Twig\Loader\FilesystemLoader;
...
class Loader
{
    ...
    public function get_twig()
    {
        ...
        if (\WP_DEBUG) {
            $twig->addExtension(new \PicowindDeps\Twig\Extension\DebugExtension());
        } else {
