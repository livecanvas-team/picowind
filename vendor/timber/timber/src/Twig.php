...
use Exception;
use PicowindDeps\Timber\Factory\PostFactory;
use PicowindDeps\Timber\Factory\TermFactory;
use PicowindDeps\Twig\DeprecatedCallableInfo;
use PicowindDeps\Twig\Environment;
use PicowindDeps\Twig\Extension\CoreExtension;
use PicowindDeps\Twig\Extension\EscaperExtension;
use PicowindDeps\Twig\Runtime\EscaperRuntime;
...
class Twig
{
    ...
    public function get_timber_functions()
    {
        ...
        $functions = [
            ...
            }, 'options' => ['deprecation_info' => new DeprecatedCallableInfo(package: 'timber/timber', version: '2.0.0', altName: '{{ get_post() }} or {{ get_posts() }}', altPackage: null, altVersion: null)]],
            ...
            'Image' => ['callable' => function ($post_id) use ($post_factory) {
                ...
                return $post_factory->from($post_id);
            }, 'options' => ['deprecation_info' => new DeprecatedCallableInfo(package: 'timber/timber', version: '2.0.0', altName: '{{ get_image() }}', altPackage: null, altVersion: null)]],
            ...
            }, 'options' => ['deprecation_info' => new DeprecatedCallableInfo(package: 'timber/timber', version: '2.0.0', altName: '{{ get_term() }}', altPackage: null, altVersion: null)]],
            'TimberTerm' => ['callable' => function ($term_id) use ($termFactory) {
                Helper::deprecated('{{ TimberTerm() }}', '{{ get_term() }} or {{ get_terms() }}', '2.0.0');
                return $termFactory->from($term_id);
            }, 'options' => ['deprecation_info' => new DeprecatedCallableInfo(package: 'timber/timber', version: '2.0.0', altName: '{{ get_term() }} or {{ get_terms() }}', altPackage: null, altVersion: null)]],
            'User' => ['callable' => function ($user_id) {
                Helper::deprecated('{{ User() }}', '{{ get_user() }} or {{ get_users() }}', '2.0.0');
                return Timber::get_user($user_id);
            }, 'options' => ['deprecation_info' => new DeprecatedCallableInfo(package: 'timber/timber', version: '2.0.0', altName: '{{ get_user() }} or {{ get_users() }}', altPackage: null, altVersion: null)]],
    ...
    public function get_timber_filters()
    {
        $filters = [
            /* image filters */
            'resize' => ['callable' => [ImageHelper::class, 'resize']],
            'retina' => ['callable' => [ImageHelper::class, 'retina_resize']],
            'letterbox' => ['callable' => [ImageHelper::class, 'letterbox']],
            'tojpg' => ['callable' => [ImageHelper::class, 'img_to_jpg']],
            'towebp' => ['callable' => [ImageHelper::class, 'img_to_webp']],
            // Debugging filters.
            'get_class' => ['callable' => function ($obj) {
                Helper::deprecated('{{ my_object | get_class }}', "{{ function('get_class', my_object) }}", '2.0.0');
                return $obj::class;
            }, 'options' => ['deprecation_info' => new DeprecatedCallableInfo(package: 'timber/timber', version: '2.0.0', altName: "{{ function('get_class', my_object) }}", altPackage: null, altVersion: null)]],
            'print_r' => ['callable' => function ($arr) {
                Helper::deprecated('{{ my_object | print_r }}', '{{ dump(my_object) }}', '2.0.0');
                return \print_r($arr, \true);
            }, 'options' => ['deprecation_info' => new DeprecatedCallableInfo(package: 'timber/timber', version: '2.0.0', altName: '{{ dump(my_object) }}', altPackage: null, altVersion: null)]],
            // Other filters.
            'stripshortcodes' => ['callable' => 'strip_shortcodes'],
            'array' => ['callable' => [$this, 'to_array']],
            'excerpt' => ['callable' => 'wp_trim_words'],
            'excerpt_chars' => ['callable' => [TextHelper::class, 'trim_characters']],
            'function' => ['callable' => [$this, 'exec_function']],
            ...
            'pluck' => ['callable' => [Helper::class, 'pluck']],
            'wp_list_filter' => ['callable' => [Helper::class, 'wp_list_filter']],
            'relative' => ['callable' => fn($link) => URLHelper::get_rel_url($link, \true)],
            /**
             * Date and Time filters.
             */
            'date' => ['callable' => [$this, 'twig_date_format_filter'], 'options' => ['needs_environment' => \true]],
            'time_ago' => ['callable' => [DateTimeHelper::class, 'time_ago']],
            'truncate' => ['callable' => fn($text, $len) => TextHelper::trim_words($text, $len)],
            // Numbers filters
