...
use WP_Post;
use PicowindDeps\WPML_LS_Menu_Item;
class WpmlIntegration implements IntegrationInterface
{
    public function should_init(): bool
    {
        return \function_exists('PicowindDeps\wpml_object_id_filter');
    }
    ...
    {
        if (\defined('PicowindDeps\ICL_LANGUAGE_CODE')) {
    ...
    public function theme_mod_nav_menu_locations($locations)
    {
        ...
        return \array_map(fn($id) => \PicowindDeps\wpml_object_id_filter($id, 'nav_menu'), $locations);
    }
}
