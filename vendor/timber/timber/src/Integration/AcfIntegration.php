...
class AcfIntegration implements IntegrationInterface
{
    ...
    {
        return \PicowindDeps\get_field_object($field_name, $post_id);
    }
    /**
    ...
    public static function term_set_meta($value, $field, $term_id, $term)
    {
        ...
        \PicowindDeps\update_field($field, $value, $searcher);
        return $value;
    }
    /**
    ...
    public static function transform_date_picker($value, $id, $field)
    {
        ...
        return new DateTimeImmutable(\PicowindDeps\acf_format_date($value, 'Y-m-d H:i:s'));
    }
    /**
    ...
    private static function get_meta($value, $id, $field_name, $args)
    {
        ...
        if (!$args['transform_value']) {
            return \PicowindDeps\get_field($field_name, $id, $args['format_value']);
        }
        /**
         ...
         */
        $file_field_type = \PicowindDeps\acf_get_field_type('file');
        $image_field_type = \PicowindDeps\acf_get_field_type('image');
        $gallery_field_type = \PicowindDeps\acf_get_field_type('gallery');
        $date_picker_field_type = \PicowindDeps\acf_get_field_type('date_picker');
        $date_time_picker_field_type = \PicowindDeps\acf_get_field_type('date_time_picker');
        $post_object_field_type = \PicowindDeps\acf_get_field_type('post_object');
        $relationship_field_type = \PicowindDeps\acf_get_field_type('relationship');
        $taxonomy_field_type = \PicowindDeps\acf_get_field_type('taxonomy');
        $user_field_type = \PicowindDeps\acf_get_field_type('user');
        ...
        $value = \PicowindDeps\get_field($field_name, $id, \true);
