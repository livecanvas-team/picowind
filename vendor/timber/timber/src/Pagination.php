    ...
    public static function paginate_links($args = [])
    {
        ...
        for ($n = 1; $n <= $args['total']; $n++) {
            ...
            if ($n == $args['current']) {
                ...
                $dots = \true;
            } else if ($args['show_all'] || ($n <= (int) $args['start_size'] || $args['current'] && $n >= (int) $args['current'] - (int) $args['mid_size'] && $n <= (int) $args['current'] + (int) $args['mid_size'] || $n > (int) $args['total'] - (int) $args['end_size'])) {
