...
namespace PicowindDeps\Timber\Factory;

use InvalidArgumentException;
use PicowindDeps\Timber\Attachment;
use PicowindDeps\Timber\CoreInterface;
use PicowindDeps\Timber\Helper;
use PicowindDeps\Timber\Image;
use PicowindDeps\Timber\PathHelper;
use PicowindDeps\Timber\Post;
use PicowindDeps\Timber\PostArrayObject;
use PicowindDeps\Timber\PostQuery;
use WP_Post;
use WP_Query;
/**
...
class PostFactory
{
    ...
    protected function from_post_object(object $obj): CoreInterface
    {
        ...
        throw new InvalidArgumentException(\sprintf('Expected an instance of Timber\CoreInterface or WP_Post, got %s', $obj::class));
    }
    ...
    protected function get_post_class(WP_Post $post): string
    {
         ...
         */
        if ('deprecated' !== \apply_filters('PicowindDeps\Timber\PostClassMap', 'deprecated')) {
    ...
    protected function is_image(WP_Post $post)
    {
         ...
         * @since 2.0.0
         */
        $extensions = \apply_filters('timber/post/image_extensions', ['jpg', 'jpeg', 'jpe', 'gif', 'png', 'svg', 'webp', 'avif']);
