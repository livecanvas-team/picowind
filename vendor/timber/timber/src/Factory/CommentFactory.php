...
use PicowindDeps\Timber\Comment;
...
class CommentFactory
{
    ...
    protected function from_comment_object(object $comment): CoreInterface
    {
        ...
        throw new InvalidArgumentException(\sprintf('Expected an instance of Timber\CoreInterface or WP_Comment, got %s', $comment::class));
    }
