...
class PagesMenu extends Menu
{
    ...
    public static function build($menu, $args = []): ?self
    {
         ...
         */
        $defaults = ['sort_column' => 'menu_order, post_title', 'echo' => \true, 'link_before' => '', 'link_after' => '', 'before' => '<ul>', 'after' => '</ul>', 'item_spacing' => 'discard', 'walker' => '', 'menu' => '', 'theme_location' => '', 'menu_id' => '', 'menu_class' => 'menu', 'container' => 'div'];
