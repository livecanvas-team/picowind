...
use PicowindDeps\Jenssegers\Blade\Application;
use PicowindDeps\Illuminate\Contracts\Container\Container as ContainerInterface;
use PicowindDeps\Illuminate\Contracts\View\Factory as FactoryContract;
use PicowindDeps\Illuminate\Contracts\View\View;
use PicowindDeps\Illuminate\Events\Dispatcher;
use PicowindDeps\Illuminate\Filesystem\Filesystem;
use PicowindDeps\Illuminate\Support\Facades\Facade;
...
class Blade implements FactoryContract
{
    ...
    protected function setupContainer(array $viewPaths, string $cachePath)
    {
        ...
        $this->container->bindIf('config', function () use ($viewPaths, $cachePath) {
            return new Config(['view.paths' => $viewPaths, 'view.compiled' => $cachePath]);
        }, \true);
