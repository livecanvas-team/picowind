...
use PicowindDeps\Carbon\CarbonImmutable;
use PicowindDeps\Carbon\CarbonInterface;
use PicowindDeps\Carbon\CarbonInterval;
use PicowindDeps\Carbon\CarbonPeriod;
use PicowindDeps\Carbon\CarbonPeriodImmutable;
use PicowindDeps\Carbon\Exceptions\UnitException;
use Closure;
use DateTime;
...
trait Converter
{
    ...
    public function __toString()
    {
        ...
        return $format instanceof Closure ? $format($this) : $this->rawFormat($format ?: (\defined('PicowindDeps\static::DEFAULT_TO_STRING_FORMAT') ? static::DEFAULT_TO_STRING_FORMAT : CarbonInterface::DEFAULT_TO_STRING_FORMAT));
    }
    /**
    ...
    {
        return $this->avoidMutation()->setTimezone('GMT')->rawFormat(\defined('PicowindDeps\static::RFC7231_FORMAT') ? static::RFC7231_FORMAT : CarbonInterface::RFC7231_FORMAT);
    }
    /**
