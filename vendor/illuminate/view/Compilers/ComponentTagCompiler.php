...
namespace PicowindDeps\Illuminate\View\Compilers;

use PicowindDeps\Illuminate\Container\Container;
use PicowindDeps\Illuminate\Contracts\Foundation\Application;
use PicowindDeps\Illuminate\Contracts\View\Factory;
use PicowindDeps\Illuminate\Filesystem\Filesystem;
use PicowindDeps\Illuminate\Support\Str;
use PicowindDeps\Illuminate\View\AnonymousComponent;
use PicowindDeps\Illuminate\View\DynamicComponent;
use PicowindDeps\Illuminate\View\ViewFinderInterface;
...
<?php if (isset($attributes) && $attributes instanceof PicowindDeps\Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(' . $class . '::class))->getConstructor()): ?>
