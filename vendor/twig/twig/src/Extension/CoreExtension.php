...
use PicowindDeps\Twig\DeprecatedCallableInfo;
use PicowindDeps\Twig\Environment;
use PicowindDeps\Twig\Error\LoaderError;
use PicowindDeps\Twig\Error\RuntimeError;
use PicowindDeps\Twig\Error\SyntaxError;
use PicowindDeps\Twig\ExpressionParser\Infix\ArrowExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Infix\AssignmentExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Infix\BinaryOperatorExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Infix\ConditionalTernaryExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Infix\DotExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Infix\FilterExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Infix\FunctionExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Infix\IsExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Infix\IsNotExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Infix\SquareBracketExpressionParser;
use PicowindDeps\Twig\ExpressionParser\InfixAssociativity;
use PicowindDeps\Twig\ExpressionParser\PrecedenceChange;
use PicowindDeps\Twig\ExpressionParser\Prefix\GroupingExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Prefix\LiteralExpressionParser;
use PicowindDeps\Twig\ExpressionParser\Prefix\UnaryOperatorExpressionParser;
use PicowindDeps\Twig\Markup;
use PicowindDeps\Twig\Node\Expression\AbstractExpression;
use PicowindDeps\Twig\Node\Expression\Binary\AddBinary;
use PicowindDeps\Twig\Node\Expression\Binary\AndBinary;
use PicowindDeps\Twig\Node\Expression\Binary\BitwiseAndBinary;
use PicowindDeps\Twig\Node\Expression\Binary\BitwiseOrBinary;
use PicowindDeps\Twig\Node\Expression\Binary\BitwiseXorBinary;
use PicowindDeps\Twig\Node\Expression\Binary\ConcatBinary;
use PicowindDeps\Twig\Node\Expression\Binary\DivBinary;
use PicowindDeps\Twig\Node\Expression\Binary\ElvisBinary;
use PicowindDeps\Twig\Node\Expression\Binary\EndsWithBinary;
use PicowindDeps\Twig\Node\Expression\Binary\EqualBinary;
use PicowindDeps\Twig\Node\Expression\Binary\FloorDivBinary;
use PicowindDeps\Twig\Node\Expression\Binary\GreaterBinary;
use PicowindDeps\Twig\Node\Expression\Binary\GreaterEqualBinary;
use PicowindDeps\Twig\Node\Expression\Binary\HasEveryBinary;
use PicowindDeps\Twig\Node\Expression\Binary\HasSomeBinary;
use PicowindDeps\Twig\Node\Expression\Binary\InBinary;
use PicowindDeps\Twig\Node\Expression\Binary\LessBinary;
use PicowindDeps\Twig\Node\Expression\Binary\LessEqualBinary;
use PicowindDeps\Twig\Node\Expression\Binary\MatchesBinary;
use PicowindDeps\Twig\Node\Expression\Binary\ModBinary;
use PicowindDeps\Twig\Node\Expression\Binary\MulBinary;
use PicowindDeps\Twig\Node\Expression\Binary\NotEqualBinary;
use PicowindDeps\Twig\Node\Expression\Binary\NotInBinary;
use PicowindDeps\Twig\Node\Expression\Binary\NotSameAsBinary;
use PicowindDeps\Twig\Node\Expression\Binary\NullCoalesceBinary;
use PicowindDeps\Twig\Node\Expression\Binary\OrBinary;
use PicowindDeps\Twig\Node\Expression\Binary\PowerBinary;
use PicowindDeps\Twig\Node\Expression\Binary\RangeBinary;
use PicowindDeps\Twig\Node\Expression\Binary\SameAsBinary;
use PicowindDeps\Twig\Node\Expression\Binary\SpaceshipBinary;
use PicowindDeps\Twig\Node\Expression\Binary\StartsWithBinary;
use PicowindDeps\Twig\Node\Expression\Binary\SubBinary;
use PicowindDeps\Twig\Node\Expression\Binary\XorBinary;
use PicowindDeps\Twig\Node\Expression\BlockReferenceExpression;
use PicowindDeps\Twig\Node\Expression\Filter\DefaultFilter;
use PicowindDeps\Twig\Node\Expression\FunctionNode\EnumCasesFunction;
use PicowindDeps\Twig\Node\Expression\FunctionNode\EnumFunction;
use PicowindDeps\Twig\Node\Expression\GetAttrExpression;
use PicowindDeps\Twig\Node\Expression\ParentExpression;
use PicowindDeps\Twig\Node\Expression\Test\ConstantTest;
use PicowindDeps\Twig\Node\Expression\Test\DefinedTest;
use PicowindDeps\Twig\Node\Expression\Test\DivisiblebyTest;
use PicowindDeps\Twig\Node\Expression\Test\EvenTest;
use PicowindDeps\Twig\Node\Expression\Test\NullTest;
use PicowindDeps\Twig\Node\Expression\Test\OddTest;
use PicowindDeps\Twig\Node\Expression\Test\SameasTest;
use PicowindDeps\Twig\Node\Expression\Test\TrueTest;
use PicowindDeps\Twig\Node\Expression\Unary\NegUnary;
use PicowindDeps\Twig\Node\Expression\Unary\NotUnary;
use PicowindDeps\Twig\Node\Expression\Unary\PosUnary;
use PicowindDeps\Twig\Node\Expression\Unary\SpreadUnary;
use PicowindDeps\Twig\Node\Node;
use PicowindDeps\Twig\Parser;
use PicowindDeps\Twig\Sandbox\SecurityNotAllowedMethodError;
use PicowindDeps\Twig\Sandbox\SecurityNotAllowedPropertyError;
use PicowindDeps\Twig\Source;
use PicowindDeps\Twig\Template;
use PicowindDeps\Twig\TemplateWrapper;
use PicowindDeps\Twig\TokenParser\ApplyTokenParser;
use PicowindDeps\Twig\TokenParser\BlockTokenParser;
use PicowindDeps\Twig\TokenParser\DeprecatedTokenParser;
use PicowindDeps\Twig\TokenParser\DoTokenParser;
use PicowindDeps\Twig\TokenParser\EmbedTokenParser;
use PicowindDeps\Twig\TokenParser\ExtendsTokenParser;
use PicowindDeps\Twig\TokenParser\FlushTokenParser;
use PicowindDeps\Twig\TokenParser\ForTokenParser;
use PicowindDeps\Twig\TokenParser\FromTokenParser;
use PicowindDeps\Twig\TokenParser\GuardTokenParser;
use PicowindDeps\Twig\TokenParser\IfTokenParser;
use PicowindDeps\Twig\TokenParser\ImportTokenParser;
use PicowindDeps\Twig\TokenParser\IncludeTokenParser;
use PicowindDeps\Twig\TokenParser\MacroTokenParser;
use PicowindDeps\Twig\TokenParser\SetTokenParser;
use PicowindDeps\Twig\TokenParser\TypesTokenParser;
use PicowindDeps\Twig\TokenParser\UseTokenParser;
use PicowindDeps\Twig\TokenParser\WithTokenParser;
use PicowindDeps\Twig\TwigFilter;
use PicowindDeps\Twig\TwigFunction;
use PicowindDeps\Twig\TwigTest;
use PicowindDeps\Twig\Util\CallableArgumentsExtractor;
final class CoreExtension extends AbstractExtension
{
    ...
    {
        if (!\function_exists('iconv') && !\function_exists('PicowindDeps\iconv')) {
