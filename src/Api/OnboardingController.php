...
final class OnboardingController
{
    ...
    {
        $catalog = ['windpress' => ['id' => 'windpress', 'name' => 'WindPress', 'slug' => 'windpress', 'source' => 'wporg', 'url' => 'https://wordpress.org/plugins/windpress/', 'description' => 'Tailwind CSS integration for WordPress.'], 'yabe-webfont' => ['id' => 'yabe-webfont', 'name' => 'Yabe Webfont', 'slug' => 'yabe-webfont', 'source' => 'wporg', 'url' => 'https://wordpress.org/plugins/yabe-webfont/', 'description' => 'Use custom fonts, Google Fonts, or Adobe Fonts.'], 'omni-icon' => ['id' => 'omni-icon', 'name' => 'Omni Icon', 'slug' => 'omni-icon', 'source' => 'wporg', 'url' => 'https://wordpress.org/plugins/omni-icon/', 'description' => 'Modern SVG icon library for WordPress.'], 'livecanvas' => ['id' => 'livecanvas', 'name' => 'LiveCanvas', 'slug' => 'livecanvas', 'source' => 'external', 'url' => 'https://livecanvas.com/', 'description' => 'Professional page builder for WordPress with front-end editing.']];
