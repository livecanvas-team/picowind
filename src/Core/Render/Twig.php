...
class Twig
{
    public function __construct()
    {
        ...
        Timber::$dirname = [UtilsTheme::get_template_directory_names()];
    }
    ...
    {
        $twigEnvironment->addFunction(new TwigFunction('blade', $this->renderBladeTemplate(...), ['is_safe' => ['html'], 'needs_context' => \true]));
    ...
    {
        $twigEnvironment->addFunction(new TwigFunction('latte', $this->renderLatteTemplate(...), ['is_safe' => ['html'], 'needs_context' => \true]));
        return $twigEnvironment;
    }
    #[Hook('timber/twig', 'filter')]
