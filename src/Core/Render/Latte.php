...
use PicowindDeps\Latte\Loaders\StringLoader;
...
class Latte
{
     ...
     */
    private const LATTE_FUNCTION_ALIASES = ['function' => 'call', 'fn' => 'call'];
    ...
    public function render_string(string $template_string, array $context = [], bool $print = \true)
    {
        ...
        try {
            ...
            $this->latte->setLoader(new StringLoader([$templateKey => $template_string]));
