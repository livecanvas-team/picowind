...
{
    public function parse(Token $token): \Picowind\Core\Render\Twig\BladeNode
    {
        ...
        return new \Picowind\Core\Render\Twig\BladeNode($template, $with, $only, $lineno, $this->getTag());
    }
