...
{
    public function parse(Token $token): \Picowind\Core\Render\Twig\LatteNode
    {
        ...
        return new \Picowind\Core\Render\Twig\LatteNode($template, $with, $only, $lineno, $this->getTag());
    }
