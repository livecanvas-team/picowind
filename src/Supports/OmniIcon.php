...
class OmniIcon
{
    ...
    private function is_omni_icon_active(): bool
    {
        ...
        return class_exists('PicowindDeps\OmniIcon\Plugin');
    }
    /**
    ...
    private function get_icon_service()
    {
        ...
        try {
            $plugin = \PicowindDeps\OmniIcon\Plugin::get_instance();
            $container = $plugin->container();
            return $container->get(\PicowindDeps\OmniIcon\Services\IconService::class);
        } catch (\Exception $e) {
