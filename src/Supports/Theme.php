...
class Theme
{
    ...
    public function setup_theme_supports(): void
    {
        ...
        register_nav_menus(['primary' => __('Primary Menu', 'picowind'), 'secondary' => __('Secondary Menu', 'picowind')]);
        /*
        ...
        add_theme_support('custom-background', apply_filters('f!picowind/theme/support:custom_background', ['default-color' => 'ffffff', 'default-image' => '']));
    ...
    public function admin_page(): void
    {
        ...
        $hook = add_theme_page(__('Picowind', 'picowind'), __('Picowind', 'picowind'), 'manage_options', 'picowind', fn() => $this->render_admin_page(), 1000001);
    }
    ...
    public function load_admin_page(): void
    {
        ...
        add_action('admin_enqueue_scripts', fn() => $this->admin_page_metadata(), 1000001);
        add_action('admin_enqueue_scripts', fn() => $this->admin_page_scripts(), 1000001);
    }
