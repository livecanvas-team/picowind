    ...
    <div id="container-content-single" class="container position-relative p-5 bg-body text-body-emphasis shadow mt-lg-n7 rounded" >
            ...
            <div class="col-md-12">
                ...
                if (!get_theme_mod("singlepost_disable_entry_cats") &&  has_category() ) {
                        ...
                        <div class="entry-categories">
                            <span class="screen-reader-text"><?php _e( 'Categories', 'picowind' ); ?></span>
                    ...
                    <div class="post-meta" id="single-post-meta">
                        <p class="lead opacity-75">
                            ...
                            <?php if (!get_theme_mod("singlepost_disable_author") ): ?>
                                <span class="post-author"> <?php _e( 'by', 'picowind' ) ?> <?php the_author(); ?></span>
                            <?php endif; ?>
                        </p>
                    </div> 
                <?php endif; ?>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                if( get_theme_mod("enable_sharing_buttons")) picowind_the_sharing_buttons();
                
                edit_post_link( __( 'Edit this post', 'picowind' ), '<p class="text-end">', '</p>' );
...
<?php
    endwhile;
     ...
     _e( 'Sorry, no posts matched your criteria.', 'picowind' );
 endif;
 ?>
