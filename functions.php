...
$picowind_includes = array(
	...
	'/navwalker.php',    			// Load custom WordPress nav walker. 
	'/woocommerce.php',                     // Load WooCommerce functions.
	'/editor.php',                          // Load Editor functions. 
	'/customizer-assets/customizer.php',	//Defines Customizer options
	//'/options-page.php',                  // Load theme options page. UNUSED FOR NOW
...
foreach ( $picowind_includes as $file ) {
